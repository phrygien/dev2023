<main class="main-content w-full px-[var(--margin-x)] pb-8">
                ...
                <div class="card">
                    <div class="tabs flex flex-col">
                        <div class="tab-content p-4 sm:p-5">
                            <div class="space-y-5">
                                <label class="block">
                                    <span class="font-medium text-slate-600 dark:text-navy-100">{{ __('Libelle cycle') }}</span>
                                    <input wire:model="cycle_name"
                                        class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                        placeholder="" type="text" />
                                        @error('cycle_name') <p class="alert flex rounded-lg bg-error px-4 py-4 text-white sm:px-5">{{ $message }}</p> @enderror
                                </label>
                                <label class="block">
                                    <span class="font-medium text-slate-600 dark:text-navy-100">{{ __('Code cycle') }}</span>
                                    <input wire:model="cycle_code"
                                        class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                        placeholder="" type="text" />
                                        @error('cycle_code') <p class="alert flex rounded-lg bg-error px-4 py-4 text-white sm:px-5">{{ $message }}</p> @enderror
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
        ...
        <div class="card mt-3">
            ...
            <table class="is-hoverable w-full text-left" wire:init="loadCycles">
                <thead>
                <tr>
                    <th
                ...
                >
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ $cycle->id }}</td>
                    <td
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        ...
                        <button wire:click="delete({{ $cycle->id }})"
